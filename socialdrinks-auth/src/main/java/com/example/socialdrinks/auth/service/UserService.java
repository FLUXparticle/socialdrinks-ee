...
public class UserService {
    ...
    public User authenticate(final String username, final String password) throws Exception {
        ...
        throw new Exception("Failed login with name '" + username + "': unknown username or wrong password");
    }

    private static Map.Entry<String, User> userEntry(String username) {
        return Map.entry(username, new User(username, "Secret123", username));
    }
